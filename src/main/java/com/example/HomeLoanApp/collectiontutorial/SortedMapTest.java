...
public class SortedMapTest {
    public static void main(String[] args) {
        ...
        SortedMap<Person, Integer> personsById = new TreeMap<>(Comparator.comparing(Person::getId));

        // Add soem persons to the set
        personsById.put(new Person(4, "John"),2);
        personsById.put(new Person(2, "Adam"),3);
        personsById.put(new Person(3, "Eve"),1);
        System.out.println("Sorted Map: " + personsById);
